...
# 1.instance variables                      1.insatance methods
...
# 2.so, instance vriables also called as object level variables

#where we have to declare instance variables:
# 1.inside the constructer by using self
...
# 2.out side the class by using object reference variable       2.del objectreference.variable name
